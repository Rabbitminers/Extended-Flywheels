...
public class FlywheelMaterialList<T extends Block, E extends Enum<E> & IFlywheelMaterial>
        implements Iterable<BlockEntry<T>> {

    private final BlockEntry<?>[] values;

    public FlywheelMaterialList(Class<E> e, Function<E, BlockEntry<? extends T>> filler) {
